...
# 简单起见，省略 name 选项，此时 name 默认为 kind
# 因此以下命令与指定 --name kind 的执行结果完全相同
# kind create cluster --config kind-config.yaml

# 不能省略 config 选项，因为以下命令只能生成单节点集群
# kind create cluster
```
...
| ----------------------------------- | ---------- | ------------- | ------- | ----------- |
| my-multi-node-cluster-control-plane | Ready      | control-plane | 1m      | v1.31.0     |
| my-multi-node-cluster-worker        | Ready      | <none>        | 1m      | v1.31.0     |
| my-multi-node-cluster-worker2       | Ready      | <none>        | 1m      | v1.31.0     |
